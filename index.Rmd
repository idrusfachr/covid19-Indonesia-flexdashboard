...
Visualisasi perkembangan kasus Covid-19 di Indonesia. Data harian bersumber dari [covid19.go.id](https://data.covid19.go.id/) dan data perprovinsi dari [BNPB](https://bnpb-inacovid19.hub.arcgis.com/). Data update setiap hari.
...
Perprovinsi {data-navmenu="Menu B"}
==============================================================================
