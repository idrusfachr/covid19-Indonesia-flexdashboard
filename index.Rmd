...
case_prov_daily_plot <- hchart(case_by_prov_daily, "line", 
  ...
  hc_caption(
    text = sprintf("Last Update : %s", max(ina_province$Tanggal))
    )

case_prov_daily_plot
```

> NOTE : Terdapat anomali di tanggal 3 Agustus pada data penambahan kasus perprovinsi yang bersumber dari BNPB. Terdapat perbedaan hingga ratusan kali lipat dengan data penambahan secara nasional di tanggal yang sama, juga berebda dengan data penambahan harian resmi di tiap provinsi. Karena average sensitif terhadap outlier, maka data tanggal di-exclude dari perhitungan rolling average.
